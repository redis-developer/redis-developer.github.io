---
id: index-import
title: 6. Import datasets
sidebar_label: 6. Import datasets
slug: /howtos/moviesdatabase/import
---
...
- More movies _to discover more queries_.
- Theaters _to discover the geospatial capabilities_.
- Users _to do some aggregations_.
...
The file `sample-app/redisearch-docker/dataset/import_theaters.redis` is a script that creates 117 Hashes (used for Geospatial queries). _This dataset is a list of New York Theaters, and not movie theaters, but it is not that critical for this project ;)._
