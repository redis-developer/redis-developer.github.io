---
id: index-manage
title: 5. Manage Index
sidebar_label: 5. Manage Index
slug: /howtos/moviesdatabase/manage
---
...
As you are building your application and add more information to the database you may need to add new fields to the index. The `FT.ALTER` command enables you to do this.
