---
id: index-advancedoption
title: 9. Advanced Option
sidebar_label: 9. Advanced Option
slug: /howtos/moviesdatabase/advancedoption
---
...
The [`FILTER`](https://oss.redis.com/redisearch/Aggregations/#filter_expressions)` expression is using the [aggregation filter syntax](https://oss.redis.com/redisearch/Aggregations/#filter_expressions), for example for the genre and release year it will be
