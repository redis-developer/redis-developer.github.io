...
title: How to build Shopping cart app using Redis
sidebar_label: How to build Shopping cart app using  Redis
...
Install the below software in your local system:
