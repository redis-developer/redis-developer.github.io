...
- Redis Time Series gets updated and Redis Data Source for Grafana displays the dashboard
...
- [Build modern fraud-detection platforms with Redis Cloud](https://redis.com/solutions/use-cases/fraud-detection/)
- [Redis Cloud to Power Modern Fraud-Detection Platforms](https://lp.redis.com/rs/915-NFD-128/images/RedisLabs-Solution-Fraud-Detection.pdf)
- [LifeLock Counts on Redis Cloud for Fraud Mitigation](https://redis.com/docs/lifelock-counts-redis-enterprise-fraud-mitigation/)
