...
title: How to Build a Social Network Application using Redis Stack and NodeJS
sidebar_label: Building a Social Network Application using Redis Stack
...
![alt_text](images/searchindex.png)
...
- [Skillmarket Backend](https://github.com/julianmateu/skillmarket-backend)
- [Skillmarket Frontend](https://github.com/julianmateu/skillmarket-front)
- [Search Tutorial](https://github.com/RediSearch/redisearch-getting-started)
