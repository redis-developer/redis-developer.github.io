...
### Step 7. Running the wrapper task
...
### Step 8. Performing the build task
...
### Step 10. Accessing the leaderboard application
...
- [Build a Real-Time Leaderboard app using Redis & Nodejs](https://github.com/redis-developer/basic-redis-leaderboard-demo-nodejs)
- [Build a Real-Time Leaderboard app using Redis & Ruby](https://github.com/redis-developer/basic-redis-leaderboard-demo-ruby)
- [Build a Real-Time Leaderboard app using Redis & Python](https://github.com/redis-developer/basic-redis-leaderboard-demo-python)
- [Build a Real-Time Leaderboard app using Redis & .NET](https://github.com/redis-developer/basic-redis-leaderboard-demo-dotnet)
- [Build a Real-Time Leaderboard app using Redis & Go](https://github.com/redis-developer/basic-redis-leaderboard-demo-go)
