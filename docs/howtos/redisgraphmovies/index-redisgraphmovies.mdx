...
sidebar_label: Building Movies database app using RedisGraph and NodeJS
slug: /howtos/redisgraphmovies
---

This application is an IMDB clone with basic account authentication and movie recommendation functionality.
It shows how to use RedisGraph in NodeJS.
...
### Step 2. Run Redismod Docker container
...
### Step 8. Accessing the Movie app
...
###  Step 9. Sign up for a new account
...
### Step 10. Sign-in to movie app

![movieapp](moviedb_sign.png)

### Step 11. Rate the movie

![movieapp](moviedb_rating.png)

### Step 12. View the list of rated movie

![movieapp](moviedb_rated.png)

### Step 13. View Movie graph on RedisInsight
...
### Step 14. Find movies where actor acted in.
...
### Step 15. Store a user in a database
...
### Step 16. Find a user by username
