...
[Go-ReJSON](https://github.com/nitishm/go-rejson) is a Go client for ReJSON Redis Module. It is a Golang client that support multiple Redis clients such as the print-like Redis-api client [redigo](/develop/golang/) and the type-safe Redis client [go-redis](/develop/golang/).
