...
Pycograph is an open source tool that creates a RedisGraph model of your Python code. The tool lets you to query the python code with Cypher. You can also visualize it with Redis GUI tool called RedisInsight.
