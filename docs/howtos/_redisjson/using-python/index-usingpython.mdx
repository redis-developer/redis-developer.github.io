...
sidebar_label: Redis JSON and Python
slug: /howtos/redisjson/using-python
---

[Redis JSON](https://oss.redis.com/redisjson/) is a source-available Redis feature that lets you store, manipulate, and query JSON documents in Redis. The standard Redis Python client (v4.0 or greater) supports all of the features of Redis JSON, and in this tutorial, we'll see how to get started with them.
