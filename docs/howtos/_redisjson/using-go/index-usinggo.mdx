...
[Go-ReJSON](https://github.com/nitishm/go-rejson) is a Go client for Redis JSON feature. It is a Golang client that support multiple Redis clients such as the print-like Redis-api client redigo and the type-safe Redis client go-redis.
