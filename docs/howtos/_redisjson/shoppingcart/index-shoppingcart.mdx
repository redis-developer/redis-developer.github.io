...
slug: /howtos/redisjson/shoppingcart
authors: [ajeet]
---
...
<div class="text--center">
  <iframe
    width="760"
    height="415"
    src="https://www.youtube.com/embed/Fvjn5fuUxOU"
...
- Redis compiled with JSON feature
- Express 4 backend
...
#### Compiling Redis with JSON feature

You can use the below docker compose file to run Redis server compiled with JSON feature:
...
In case you’re using Redis Enterprise Cloud instead of localhost, then you need to enter the database endpoint under REDIS_HOST (without port) while rest of the entries like REDIS_PORT and REDIS_PASSWORD are quite obvious
