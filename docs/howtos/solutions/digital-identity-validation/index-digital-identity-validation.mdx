...
In an E-commerce Application, Digital identity can be typically verified before checkout or payment of an order.

Consider below architecture flow before an order checkout
