...
<img src={cacheMissImage} alt="Cache miss when using the cache-aside pattern with Redis" width="500" className="margin-bottom--md" />
...
<img src={cacheHitImage} alt="Cache hit when using the cache-aside pattern with Redis" width="500" className="margin-bottom--md" />
