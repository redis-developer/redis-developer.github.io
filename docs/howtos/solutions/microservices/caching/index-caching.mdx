...
If you use **Redis Enterprise** and a database that uses a JDBC driver, you can take advantage of <u>[**Redis Smart Cache**](https://redis.com/blog/redis-smart-cache/)</u>, which lets you add caching to an application without changing the code. [**Click here to learn more!**](https://github.com/redis-field-engineering/redis-smart-cache)
