...
1. `mongodb` - serves as the write-optimized database, storing orders, order history, products, etc.

:::info

You do not need to use MongoDB as your write-optimized database, you can use other databases such as a SQL database as well.
