...
git clone --branch v9.0.0 https://github.com/redis-developer/redis-microservices-ecommerce-solutions
...
The image below shows the JSON structure of openAI product image summary within RedisInsight.
