...
- For more information visit the [node-redis Github repo](https://github.com/redis/node-redis), and also check JavaScript/NodeJS apps at [Redis Launchpad](https://launchpad.redis.com/)
