...
- Data Source supports:
  ...
  - [Time Series](https://redis.io/docs/stack/timeseries/): TS.GET, TS.INFO, TS.MRANGE, TS.QUERYINDEX, TS.RANGE
  - [Search and Query](https://redis.io/docs/stack/search/): FT.INFO
  - [Graph](https://redis.io/docs/stack/graph/): GRAPH.QUERY, GRAPH.SLOWLOG
...
You can also leverage Redis Cloud as showcased in the below example.
