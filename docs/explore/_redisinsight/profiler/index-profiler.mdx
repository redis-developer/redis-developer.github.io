...
Visit [redis.com/try-free](https://redis.com/try-free) and create a Redis Stack database.
...
[Follow these steps to connect to the database](https://developer.redis.com/explore/redisinsight/getting-started) using RedisInsight. Once you are connected to RedisInsight GUI, you can verify the 3 Redis Time Series keys:
