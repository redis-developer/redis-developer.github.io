...
[Follow this link to create Redis Stack database](https://redis.io/docs/get-started/document-database/) that comes with Redis Search
...
[Follow this link to create Redis Stack database](https://redis.io/docs/get-started/document-database/) that comes with Redis Search module enabled
