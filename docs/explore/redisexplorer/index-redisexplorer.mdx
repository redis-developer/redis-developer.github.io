...
title: How to Build a Grafana Dashboard for Redis Enterprise cluster  in 5 Minutes
sidebar_label: How to Build a Grafana Dashboard for Redis Enterprise Cluster using Redis Explorer
...
### Step 6. Add Redis Datasource

![My Image](datasource.png)

### Step 7. Choose Redis Explorer in the sidebar

![My Image](explorer_options.png)

### Step 8. Getting the Redis Enterprise Cluster Overview

![My Image](cluster_overview.png)

### Step 9. Displaying the Redis Enterprise Cluster Nodes
