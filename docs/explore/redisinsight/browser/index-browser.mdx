...
sidebar_label: Visualize Redis database keys 
...
[Follow this link](https://developer.redislabs.com/explore/redisinsight/getting-started) to set up RedisInsight locally.

## Step 3: Connecting to Redis database
