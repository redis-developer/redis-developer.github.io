...
If you want to add a time series data structure to your Redis database, use the RedisInsight TimeSeries browser tool. 
...
[Follow this link t](https://developer.redislabs.com/explore/redisinsight/getting-started)o setup RedisInsight locally in your system
...
## Step 7.  Displaying the tabular view
