---
id: index-profiler
title: Analyze Your Redis commands using RedisInsight Profiler tool
sidebar_label: Analyze Your Redis commands using Profiler
...
## Step 2.  Create Redis database with RedisTimeSeries module enabled

Visit [https://developer.redislabs.com/create/rediscloud](https://developer.redislabs.com/create/rediscloud) and create a Redis database. [Follow these steps to enable RedisTimeSeries module ](https://developer.redislabs.com/howtos/redistimeseries)on Redis Enterprise Cloud
...
The complete walkthrough of this python script is explained [here](https://redislabs.com/blog/how-to-manage-real-time-iot-sensor-data-in-redis/).
...
[Follow these steps to connect to the database](https://developer.redislabs.com/explore/redisinsight/getting-started) using RedisInsight. Once you are connected to RedisInsight GUI, you can verify the 3 RedisTimeSeries keys:
...
Please note that In RedisTimeSeries, only [TS.RANGE ](https://oss.redislabs.com/redistimeseries/commands/#tsrangetsrevrange)and [TS.MRANGE](https://oss.redislabs.com/redistimeseries/commands/#tsmrangetsmrevrange) are supported as of the current release. In the next release, TS.REVRANGE and TS.MREVRANGE will be supported too.
