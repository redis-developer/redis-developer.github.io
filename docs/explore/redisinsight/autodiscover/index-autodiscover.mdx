...
You can use redis client softwarsofte to connect to the remote Amazon Elasticache for Redis server endpoint URL.
...
In order to access Redis GUI, run the below docker command:
