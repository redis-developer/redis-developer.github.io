---
id: index-streams
title: Using Redis Streams with RedisInsight
sidebar_label: Using Redis Streams
...
## Step 2. Run the producer(Post a new message)
...
## Step 3. Run the consumer(Consume messages)
...
## Step 4: Posting the new messages
