...
sidebar_label: Writing Your Serverless Function using RedisGears Browser Tool
...
Support for [RedisGears](https://oss.redislabs.com/redisgears/) was first introduced in RedisInsight v1.5.0. RedisInsights allows you:
...
- [RedisGears Project](https://oss.redislabs.com/redisgears/)
