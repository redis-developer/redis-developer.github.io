---
id: index-redisgears
title: Write Your Serverless Redis function using RedisInsight Browser Tool
sidebar_label: Write Your Serverless Redis function using RedisInsight Browser Tool
...
Support for [Triggers and Functions](https://oss.redis.com/redisgears/) was first introduced in RedisInsight v1.5.0. RedisInsights allows you:
...
- [Triggers and Functions Project](https://oss.redis.com/redisgears/)
- [Triggers and Functions Tutorials](/howtos/redisgears)
- [How to build a Fraud Detection System using Probabilistic Data Structures](/howtos/frauddetection)
- [Building a Pipeline for Natural Language Processing using Redis](/howtos/nlp)
