---
id: index-redisgraph
title: Query, Visualize and Manipulate Graphs using RedisInsight Browser Tool
sidebar_label: Query and Manipulate Graphs using RedisInsight
slug: /explore/redisinsight/redisgraph
---
...
*   UX for large queries; fixed long pause while results are being rendered
...
[Follow this link to create a Redis database](https://developer.redislabs.com/howtos/redisgraph) using Redis Enterprise Cloud with RedisGraph module enabled
...
## Step 2. Run RedisInsight tool and connect to the Redis database

[Follow this link to setup RedisInsight ](https://developer.redislabs.com/explore/redisinsight/getting-started)and connect to the Redis database.
