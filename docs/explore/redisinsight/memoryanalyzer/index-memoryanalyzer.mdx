...
title: Reduce Redis Memory usage using RedisInsight Memory Analyzer Tool
sidebar_label: Reduce Redis Memory usage with Memory Analyzer 
...
:::
It is recommended to add a mount point using the -”v” parameter as shown below:
