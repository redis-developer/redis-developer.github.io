---
id: index-usinghelm
title: Installing RedisInsight using Helm Chart
sidebar_label: Installing RedisInsight using Helm Chart
...
:::important
Please Note: Installing RedisInsight using Helm is an experimental feature but not fully supported by Redis Labs.
:::
