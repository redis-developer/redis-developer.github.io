...
![ReidsInsight download form](images/redisinsight_form.png)
...
![Connecting to a database with RedisInsight](images/redisinsight_connection.png)
...
![RedisInsight key manager](images/redisinsight_key.png "image_tooltip")


Open "Profiler" tool to analyse your Redis commands as shown below:

![RedisInsight profiler tool](images/redisinsight_profiler.png "image_tooltip")
...
- [RU202 Redis Streams](https://university.redis.com/courses/ru202/) - a course at Redis University
##
