...
## What's New in RedisInsight v2.0 Browser Tool?

RedisInsight Browser lets you explore keys in your Redis server. You can add, edit and delete a key. You can even update the key expiry and copy the key name to be used in different places of the application. Below are the list of features available under the browser tool:
...
Open up the CLI terminal and run the below command:
