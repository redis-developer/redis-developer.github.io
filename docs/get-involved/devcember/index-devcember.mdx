...
[Join us on Twitch](https://www.twitch.tv/redisinc) for a daily 15-20 minute live stream on Monday to Friday where we'll introduce Redis concepts, share projects that you can contribute to and have some fun banter.  For Saturday and Sunday, we’ll give you a mini challenge to complete.
...
We'll be on the [Redis channel on Twitch](https://www.twitch.tv/redisinc) each working day in December… times will vary and we'll update the schedule below daily, revealing each day's topic as we go.

|Date/Time             |Topic                                                    |Join Us!                                                          |
|----------------------|---------------------------------------------------------|------------------------------------------------------------------|
|Wed 1 Dec, 9am UTC    |Welcome to DEVcember, Get Started with Redis in the Cloud|[Watch the recording](https://www.youtube.com/watch?v=jf-lwkWUQHg)|
|Thu 2 Dec, 10.30am UTC|Up and Running with RedisInsight                         |[twitch.tv](https://www.twitch.tv/redisinc)                       |
