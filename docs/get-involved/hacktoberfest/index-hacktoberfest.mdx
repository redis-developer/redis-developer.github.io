...
We've created a number of GitHub issues for folks who want to contribute to our documentation and demo apps.  You can [find them here](https://github.com/search?q=%23hacktoberfest+user%3Aredislabs-training+user%3Aredis-developer+user%3ANodeRedis+label%3Ahacktoberfest&type=Issues&ref=advsearch&l=&l=).
...
1. Look for a suitable issue [here](https://github.com/search?q=%23hacktoberfest+user%3Aredislabs-training+user%3Aredis-developer+user%3ANodeRedis+label%3Ahacktoberfest&type=Issues&ref=advsearch&l=&l=).  Where possible, we have tagged them according to the skillset and level of experience required.
...
Documentation is often cited as a great way to get your feet wet with open source.  So to demystify the world of technical writing, we will be hosting four live events with our documentation team - follow us on [Twitch](https://www.twitch.tv/redislabs) to get a reminder.  All sessions will be at 9am PT / noon ET / 4pm UTC / 5pm UK / 7pm Israel:

Friday 15th October: Fireside panel - Suze Shardlow with the documentation team: Technical Writing Explained
Monday 25th October: Fireside 1:1 - Suze Shardlow with Kaitlyn, Technical Writer
Tuesday 26th October: Fireside 1:1 - Suze Shardlow with Rachel, Technical Writer
