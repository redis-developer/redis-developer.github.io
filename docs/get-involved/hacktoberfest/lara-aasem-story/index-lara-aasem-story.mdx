...
# TODO insert screen grab of the issue
`![Screen grab of the issue](/images/*.jpg)`
...
# TODO insert screen grab of Lara asking to be assigned to the issue
`![Screen grab of Lara asking to be assigned](/images/*.jpg)`
