...
"I am a Solution Architect at Capgemini and have been using Redis for 1.5 years. I build various applications in the enterprise landscape of a major car manufacturer in Europe for Manufacturing / Supply chain using Java/J2EE.
