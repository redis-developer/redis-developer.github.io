...
## Install the redis-cli tool on this new instance by running this command:
...
## Using redis-cli to verify the connectivity with the ElastiCache database
...
# Using the RIOT migration tool

Run the commands below to set up the migration tool. 

Prerequisites: 

## Install Java: We recommended using OpenJDK 11 or later:
