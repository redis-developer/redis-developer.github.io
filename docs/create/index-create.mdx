...
<div className="ri-description-short text--center ">
    ...
    <div className="ri-detail text--center ">
        <div className="ri-title text--center "><a  href={useBaseUrl('docs/create/cloud')}>Redis Enterprise Cloud</a></div>
...
<div className="ri-description-short ">
    ...
    <div className="ri-detail ">
        <div className="ri-title"><a  href={useBaseUrl('docs/create/cloud')}>Docker</a></div>
        <div className="ri-description text--center">
        <a  href={useBaseUrl('docs/create/cloud')}>
...
<div className="ri-description-short ">
    <div className="ri-icon"><span className="fe fe-zap" /></div>
    <div className="ri-detail">
        <div className="ri-title"><a  href={useBaseUrl('docs/create/resoftware')}>Redis Enterprise Software</a></div>
        <div className="ri-description text--center ">
