...
### Step 2: Launch Microsoft Windows Store 
 ...
 ```
Upon opening the Windows Store, use the search tool to find entries related to "Linux" and install your preferred distribution (or version). Please note the rest of this tutorial is tailored to Ubuntu.
