...
![alt_text](images/preview_azurefunction.png "image_tooltip")
...
![Acount Dashboard](images/image2.png "image_tooltip")
...
![Azure Cache for Redis Service](images/image3.png "image_tooltip")

Under "New Redis Cache" window, create a new resource group, select your preferred location and cache type:


![Creating a new Redis Instance](images/image4.png "image_tooltip")
...
![Deploying your Redis Instance](images/image6.png "image_tooltip")


Once the deployment is complete, you will be provided with the deployment name, subscription details and resource group.


![Redis Instance up and running](images/image7.png "image_tooltip")
...
![Managing keys](images/keys.png "image_tooltip")
...
![Visual Studio Code download](images/image8.png "image_tooltip")


Install Visual Code Studio on your Mac system



![The Azure Functions extension for Visual Studio code](images/image9.png "image_tooltip")
...
![The Azure Functions extension for Visual Studio Code](images/image10.png "image_tooltip")
...
![Configuring Azure in Visual Studio Code](images/image13.png "image_tooltip")


### Step 10. Clone the project repository

For this tutorial, we will be using BabyNames counter app built using C#. 
...
Add “Azure Cache for Redis” endpoint URL details under local-settings.json file as shown below:
...
Open the Visual Studio Code by running the following command:
...
### Step 12. Verify the Azure function app is working properly




![Output in the browser from running the application locally](images/image17.png "image_tooltip")
...
![Redis Insight](images/image18.png "image_tooltip")
