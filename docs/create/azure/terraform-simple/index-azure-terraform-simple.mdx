...
The "azurerm_redis_enterprise_database" is a resource that manages a Redis Enterprise Database. This is a template to get started with the 'azurerm_redis_enterprise_cluster' resource available in the 'azurerm' provider with Terraform.
...
az login
```
>Alternatively, you can also login via Service Principal 
