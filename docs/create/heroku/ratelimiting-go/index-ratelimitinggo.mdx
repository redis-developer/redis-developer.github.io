...
sidebar_label: How to deploy Redis Rate Limiting application on Heroku
...
- [Deploy Java app on Heroku using Redis](http://localhost:3000/create/heroku/herokujava)
- [Deploy NodeJS app on Heroku using Redis](http://localhost:3000/create/heroku/herokunodejs)
- [Deploy Python app on Heroku using Redis](http://localhost:3000/create/heroku/herokupython)
