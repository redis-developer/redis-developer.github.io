...
Create your free Redis Enterprise Cloud account. [Follow this link to create a Redis Enterprise Cloud](https://developer.redis.com/create/rediscloud) subscription and database as shown below:
