...
Here's a quickstart guide to deploy Ruby apps over Heroku using Redis. We will be deploying a sample Leaderboard app and will be using company valuation and stock tickers as its domain.
