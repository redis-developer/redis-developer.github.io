...
:::important
The above method doesn't allow you to choose Cloud of your choice. If you want to choose your preferred Cloud as well as Redis Modules, use Redis Enterprise Cloud dashboard directly.
:::
### Next Step
