...
sidebar_label: Redis using Red Hat OpenShift Container Platform 
...
For configuring any additional parameters for the Redis Enterprise Cluster custom resource definition, visit this page.
