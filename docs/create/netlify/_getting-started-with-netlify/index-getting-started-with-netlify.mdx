...
- Step 1. Setup a Free Redis Cloud Account
...
Visit [redis.com/try-free](https://redis.com/try-free) and create a free Redis Cloud account. Select a “Redis Stack" database when you create the Redis Cloud database. Once you complete the tutorial, you will be provided with the database Endpoint URL and password. Save it for future reference.
...
### Step 8. Add Environment Variable for Redis Cloud
