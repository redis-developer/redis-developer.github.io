...
<div class="row">
 <div class="col">
     <RedisCard
        ...
        description="Learn how to deploy and host Next.js app using Netlify "
...
[In the last tutorial](/explore/netlify/getting-started-with-netlify), we leveraged [Netlify CLI](https://docs.netlify.com/cli/get-started/) to build a simple Next.js application built using TailwindCSS and Redis .
...
There are two essential settings that needs to be configured.
...
By now, you should be able to see your Docusaurus site hosted on port 3000.
