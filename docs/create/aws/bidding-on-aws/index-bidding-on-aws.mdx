...
<div>
  <a
    href="https://redis.com/try-free/?utm_medium=email&utm_source=marketo-followup&utm_campaign=2021-11-reinvent+try_free&mkt_tok=OTE1LU5GRC0xMjgAAAGCSARj9AY9-xGRHmR6vxemuDqU8NkDSMDTf1r8o4E7zjy58kDTzL2av6d4xogYhOqud8a4WEw6wu4rht5OHKW8M7vbp-u_cVNGYnhlQzkFr6mF"
    target="_blank"
    rel="noopener"
    className="link">

    <img
      src="/img/matrix200.png"
      className="thumb"
      loading="lazy"
      alt="Redis Try Free"
    />
