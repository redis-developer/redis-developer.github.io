...
[Follow this tutorial](https://developer.redis.com/create/aws/redis-on-aws) to sign up for free Redis Cloud account.
...
- [Provision and Manage Redis Cloud Anywhere with HashiCorp Terraform](https://redis.com/blog/provision-manage-redis-enterprise-cloud-hashicorp-terraform/)
