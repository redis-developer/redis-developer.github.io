...
Resource {} block has two strings before the block: resource types and resource names. The prefix of the type maps to the name of the provider. For example, the resource type “random_password” and the resource name “passwords” form a unique identifier of the resource. Terraform uses this ID to identify the resource.
...
- Install Terraform on your MacOS.
- Create a free Redis Enterprise Cloud account.
- Create your first subscription.
- Enable API


### Step 1: Install Terraform on your MacOS
...
### Step 2: Sign up for a free Red Enterprise Cloud account

Sign up for your free Redis Enterprise Cloud account. Once you click on “Get Started,” you will receive an email with a link to activate your account and complete the sign-up process.

![terraform](tryfree.png)

### Step 3: Create your subscription

Next, you will have to create a Redis Enterprise Cloud subscription. In the Redis Enterprise Cloud menu, click "New Subscription."


![terraform](subscription.png)

### Step 4: Select the right subscription plan

Select "Fixed plans for low-throughput applications” for now.

![terraform](newsubscription.png)


### Step 5: Enable Redis Enterprise Cloud API
...
### Step 7: Create an execution plan
...
Deploy Redis Database with RedisJSON modules on AWS using Terraform
