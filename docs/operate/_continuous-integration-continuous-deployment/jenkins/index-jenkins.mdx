...
![Selecting your pipeline](images/image16.png)

Click the "Build Now" icon on the left side menu.

![Building your pipeline](images/image17.png)
...
![Viewing the Python logs](images/image18.png)
...
![Viewing the git log](images/image19.png)
...
![Verifying database creation](images/image20.png)
