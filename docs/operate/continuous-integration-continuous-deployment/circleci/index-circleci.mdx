...
![CircleCI and Redis logos](images/circleci-redis.png "image_tooltip")
...
![CircleCI Overview](images/circlecidiagram.png "image_tooltip")
...
![CircleCI Login](images/circleci-login.png "image_tooltip")
...
![Authenticating](images/circleci-auth.png "image_tooltip")
...
![Heroku Environment Variables](images/heroku-envir.png "image_tooltip")

## Step 9. Trigger the build

As soon as you merge the pull request, the tool will trigger the build automatically.

![Triggering the build](images/heroku-trigger.png "image_tooltip")
...
![Application running](images/rate-limiting-example.png "image_tooltip")
