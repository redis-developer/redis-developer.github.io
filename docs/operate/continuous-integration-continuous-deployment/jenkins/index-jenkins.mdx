...
![Creating a new pipeline](images/image12.png)

Enter in a name for the pipeline, and choose the **Pipeline** type.

![Naming the pipeline](images/image13.png)
...
![Configuring GitHub access](images/image14.png)
...
![Specifying your Jenkinsfile](images/image15.png)
...
![Selecting your pipeline](images/image16.png "image_tooltip")


Click the "Build Now" icon on the left side menu.


![Building your pipeline](images/image17.png "image_tooltip")
...
![Viewing the git log](images/image19.png "image_tooltip")
...
![Verifying database creation](images/image20.png "image_tooltip")
