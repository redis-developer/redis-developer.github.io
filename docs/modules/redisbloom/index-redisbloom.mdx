...
- Count-min sketch: A count-min sketch is generally used to determine the frequency of events in a stream. You can query the count-min sketch to get an estimate of the frequency of any given event. Learn more about count-min sketch here. 
- Top-K: The Top-k probabilistic data structure in RedisBloom is a deterministic algorithm that approximates frequencies for the top k items. With Top-K, you’ll be notified in real time whenever elements enter into or are expelled from your Top-K list. If an element add-command enters the list, the dropped element will be returned. Learn more about Top-K here.



### Step 1. Register and subscribe

Follow [this](/create/cloud/rediscloud) link to register and subscribe to Redis Enterprise Cloud

![Redisbloom](redisbloom1.png)

### Step 2. Create a database with RedisBloom Module

![Redisbloom](redisbloom.png)
...
### Step 4. Getting Started with RedisBloom
...
- Learn more about RedisBloom in the [Quick Start](https://oss.redislabs.com/redisbloom/Quick_Start/) tutorial.
