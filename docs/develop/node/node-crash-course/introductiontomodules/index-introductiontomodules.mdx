...
The redis.io website has a [catalog of available modules](https://redis.io/modules).  Redis Labs has developed a number of these that extend Redis in different ways, and we'll use some of them in our sample application.
...
Redis Labs offers Redis Enterprise Cloud, a fully managed service for running and scaling Redis and Redis Labs modules.  [Sign up for Redis Enterprise Cloud](https://redislabs.com/try-free/) and use the full-featured free tier to try it out!
...
* [Modules in Redis Enterprise](https://redislabs.com/redis-enterprise/modules/)
