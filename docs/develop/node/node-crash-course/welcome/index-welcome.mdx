...
<iframe width="560" height="315" src="https://www.youtube.com/embed/1t7uqAwG-DY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

Welcome to the Node.js Redis Crash Course.  I'm [Simon Prickett](https://twitter.com/simon_prickett), Senior Curriculum Engineer at Redis Labs.  
...
* Modeling domain objects with Redis Hashes, querying them with RediSearch.
* Storing and querying document data with the RedisJSON module.
