...
- [Redis Cloud](https://redis.com/redis-enterprise-cloud/overview/) - a fully managed cloud service from Redis - you can try it out using the full featured free tier.
