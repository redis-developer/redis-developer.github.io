...
* [Redis Enterprise Cloud](https://redislabs.com/redis-enterprise-cloud/overview/) - a fully managed cloud service from Redis Labs - you can try it out using the full featured free tier.
