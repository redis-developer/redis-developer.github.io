...
<Tabs
  ...
  values={[
    ...
    {label: 'Package Refernce', value: 'csproj'},
...
[![marketplace](images/rate-limiting.png)](https://marketplace.redislabs.com/?id=project%3Abasic-redis-rate-limiting-demo-csharp-dot-net)
...
[![marketplace](images/leaderboard.png)](https://marketplace.redislabs.com/?id=project%3Abasic-redis-leaderboard-demo-dotnet)
...
[![marketplace](images/cachingMarketplace.png)](https://marketplace.redislabs.com/?id=project%3Abasic-caching-demo-csharpdotnet)
...
[![marketplace](images/chatMarketplace.png)](https://marketplace.redislabs.com/?id=project%3Abasic-redis-chat-app-demo-dotnet)
