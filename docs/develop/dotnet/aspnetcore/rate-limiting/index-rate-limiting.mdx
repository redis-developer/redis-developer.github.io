...
title: Fixed Window Rate Limiting with ASP.NET Core & Redis
sidebar_label: Fixed Window Rate Limiting
...
Cd into `FixedRateLimiter` and run the command: `dotnet add package StackExchange.Redis`
...
* The source code for the Fixed Window Rate Limiter can be found in [GitHub](https://github.com/redis-developer/fixed-rate-limiter-aspnet-core)
