...
[Movie Database app in Java](http://launchpad.redislabs.com/?id=project%3Ademo-movie-app-redisearch-java) based on RediSearch capabilities
</div>
</div>
...
[How to implement leaderboard app](http://launchpad.redislabs.com/?id=project%3Abasic-redis-leaderboard-demo-java) using Redis & Java(Spring)
</div>
</div>
</div>
