...
![marketplace](images/moviedatabasejava.png)

[Movie Database app in Java](http://marketplace.redislabs.com/?id=project%3Ademo-movie-app-redisearch-java) based on RediSearch capabilities
</div>
</div>
...
![marketplace](images/basicleaderboardjava.png)

[How to implement leaderboard app](http://marketplace.redislabs.com/?id=project%3Abasic-redis-leaderboard-demo-java) using Redis & Java(Spring)
</div>
</div>
</div>
