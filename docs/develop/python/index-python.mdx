...
slug: /develop/python/
authors: [ajeet]
keywords: [python redis, redis python, pip install redis]
---
...
<div class="text--center">
  <iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/BxRJRNt7Qwc"
    frameborder="0"
...
- [Writing Your Serverless function using RedisInsight Browser Tool](/explore/redisinsight/redisgears/)
