---
id: index-redis-om
title: Getting Started With Redis OM - Python
...
This tutorial will walk you through installing Redis OM - Python, creating your first model, and using it to save and validate data.
